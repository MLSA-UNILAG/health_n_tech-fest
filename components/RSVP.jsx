  ...
  return (
    <section className="relative">
      <div className="text-white text-center py-8 w-11/12 max-w-6xl m-auto relative">
        ...
        <RSVPAvatarMale className="w-12 h-12 md:w-20 md:h-20 lg:text-6xl absolute right-0 top-0" />
        <RSVPAvatarFemale className="w-12 h-12 md:w-20 md:h-20 absolute left-0 bottom-1/2" />
