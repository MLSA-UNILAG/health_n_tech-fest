        ...
        <div className="m-auto py-10 w-full first-letter: text-white flex flex-col justify-center text-center ">
            <div className="flex gap-6 md:gap-0 justify-center w-11/12 md:w-2/3 m-auto">
                ...
                <div className="flex flex-col flex-1 gap-3 justify-center items-center relative">
                    <div className="absolute bottom-0 left-0 translate-y-1/3">
                        <div className='w-[50px] h-[50px] sm:h-[70px] sm:w-[70px] xl:h-[100px] xl:w-[100px] top-0 rounded-full p-2 bg-gradient-to-r from-sticker_gradient_from to-sticker_gradient_to flex items-center justify-center'>
                            <StickerGirl />
                        </div>
                    </div>
                    ...
                    <div className="absolute top-0 right-0 md:-right-12">
            ...
            <div className="px-2 m-6 mt-10 md:mx-auto md:mt-16 flex flex-col gap-6 justify-center items-center w-11/12 md:w-2/3">
