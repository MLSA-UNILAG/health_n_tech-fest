    ...
    return (
        <div className="mx-24 mb-24">
            <div className="mt-[100px]">
                ...
                <div className="flex mt-10 flex-row row-span-2 text-white gap-4 items-stretch">
                    ...
                    <div className="w-[55%] flex flex-wrap columns-2 gap-8 gap-y-8 justify-center child:bg-infoCard_bg child:border-infoCard_border child:rounded-md child:border-r-2 child:border-b-2 child:py-6 child:px-8 child:max-w-[260px] child:text-center">
            ...
            <div className="mt-[100px]">
                ...
                <div className="flex mt-10 flex-row row-span-2 text-white gap-8">
                    <div className="w-[50%] border-yellow border-r-6 border-b-6 rounded-tr-sm rounded-bl-sm ">
