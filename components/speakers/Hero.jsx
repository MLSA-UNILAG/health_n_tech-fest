...
const Hero = () => {
  return (
    <section className="flex items-center justify-center text-white text-center">
      <div className='flex flex-col items-center justify-center w-11/12 m-auto max-w-6xl pb-11 md:py-10'>
          <div className='w-11/12 md:w-4/5'>
            ...
            <div className='my-2'>
              <p className='text-lg font-semibold w-4/5 m-auto'>We have selected the best to bring you amazing talks in this year&apos;s <br /> Fest. Brace up for a premium experience.</p>
